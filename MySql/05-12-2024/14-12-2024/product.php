<?php
    $db = new mysqli("localhost", "root", "", "fourteen_dec");
    ...
    if (isset($_POST['btnSubmit'])) {
        ...
        $sqlinsert = "INSERT INTO product(id,name,price,brand_id) VALUES($id,'$name','$p_price','$b_id')";
...
<body>
    <div class="container">
        ...
        while (list($id, $name, $p_price, $b_id) = $product->fetch_row()) {
            echo "<tr>
                    <td>$count</td>
                    <td>$name</td>
                    <td>$p_price</td>
